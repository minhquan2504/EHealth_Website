...
function mapDetail(e: any): EncounterDetail {
    return {
        id: String(e.id ?? e.encounter_id ?? ""),
        code: e.code ?? e.encounter_code ?? "",
        ...
        patientCode: e.patientCode ?? e.patient?.patient_code ?? e.patient?.patientCode ?? "",
        patientPhone: e.patientPhone ?? e.patient?.phone ?? e.patient?.phone_number ?? "",
        patientGender: e.patientGender ?? e.patient?.gender ?? "",
        patientDob: e.patientDob ?? e.patient?.dateOfBirth ?? e.patient?.date_of_birth ?? "",
        ...
        departmentName: e.departmentName ?? e.department_name ?? e.department?.name ?? "",
        type: e.type ?? e.encounter_type ?? "FIRST_VISIT",
        status: String(e.status ?? "OPEN").toUpperCase(),
        startedAt: e.startedAt ?? e.started_at ?? e.createdAt ?? e.created_at ?? "",
        ...
        chiefComplaint: e.chiefComplaint ?? e.chief_complaint ?? e.reason ?? "",
