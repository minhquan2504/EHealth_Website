        ...
        <div className="p-6 md:p-8"><div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="bg-white dark:bg-[#1e242b] rounded-xl border border-[#dde0e4] dark:border-[#2d353e] p-6">
                ...
                <div className="flex items-center gap-4 mb-6">
                    <div className="w-16 h-16 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-white font-bold text-xl">LT</div>
                    <div>
                        <p className="text-lg font-semibold text-[#121417] dark:text-white">{profile.name}</p>
                        <p className="text-sm text-[#687582]">Lễ tân • Quầy tiếp nhận số 1</p>
                    </div>
                </div>
            ...
            <div className="bg-white dark:bg-[#1e242b] rounded-xl border border-[#dde0e4] dark:border-[#2d353e] p-6">
                ...
                <div className="space-y-3">
                    {[
                        { l: "Lịch hẹn mới", d: "Nhận thông báo khi có lịch hẹn mới", k: "newAppointment" as const },
                        { l: "Nhắc nhở tiếp nhận", d: "Nhắc khi bệnh nhân gần đến giờ hẹn", k: "reminderCheckin" as const },
                        { l: "Thanh toán", d: "Thông báo khi có hóa đơn chờ thanh toán", k: "billing" as const },
                    ].map((n) => (
