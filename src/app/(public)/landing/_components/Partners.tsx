                    ...
                    <div className="flex items-center justify-center gap-8 md:gap-16 flex-wrap">
                        {CERTIFICATIONS.map((cert) => (
                            <div key={cert.name} className="flex flex-col items-center gap-3 group cursor-pointer">
                                <div className="relative w-20 h-20 rounded-2xl bg-white shadow-lg border border-gray-100 p-3 group-hover:shadow-xl group-hover:-translate-y-1 transition-all">
                                    <SafeImage src={cert.img} alt={cert.name} fill className="object-contain p-2" />
                                </div>
